...
const moment = require('moment-timezone'); // use timezone support
    ...
    for (const freq of frequencies) {
      ...
      // Case 2: Frequent Frequency
        ...
        if (parallelConsumption?.schedule?.length > 0) {
          ...
          // Priority 3: auto-generate interval
      ...
      // Fallback: If standard type still has parallelConsumption
