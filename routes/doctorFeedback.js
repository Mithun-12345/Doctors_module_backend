...
const { getDoctorFeedbackOption, editFeedbackParticularQuestion,viewFeedbackQuestions, editDoctorFeedbackOption,createDoctorForFeedbackOption ,createDoctorFeedback} = require("../controllers/docterfeedbackController")
...
router.post("/createDoctorForFeedbackOption",validateToken,createDoctorForFeedbackOption);
 ...
 router.get("/getDoctorFeedbackOption",validateToken,getDoctorFeedbackOption);
