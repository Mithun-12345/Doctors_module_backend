...
router.get("/ViewAllTheTypesOfQuery",validateToken,ViewAllTheTypesOfQuery);
router.get("/displayTheCreatedQuestionsForTheQuery/:id",validateToken,displayTheCreatedQuestionsForTheQuery);
router.patch("/updateReadOptionForTheQuestions/:id",validateToken,updateReadOptionForTheQuestions);
router.patch("/updateIsBotOptionForThePatient",validateToken,updateIsBotOptionForThePatient);
